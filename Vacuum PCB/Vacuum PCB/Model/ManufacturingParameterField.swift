...
struct ManufacturingParameterField: Identifiable {
    ...
    static let all: [ManufacturingParameterField] = [
        ...
        .number("resistorFlareLength", "Channels", "Resistor flare length",
                \.resistorFlareLength),
        ...
        .number("connectorPadding", "Connector", "Neck padding", \.connectorPadding),
        .number("connectorGasketWidth", "Connector", "Gasket width",
